...
import 'package:stock_app/repositories/realtime_quote_repository.dart';
                ...
                if (snapshot.hasData) {
                  ...
                  return Expanded(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        dividerThickness: 1.0, //Độ dài của đường phân cách
                        columns: const [
                    ...
                    return Center(
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          _quoteStream =
                              RealtimeQuoteRepository.getRealtimeQuoteList(
                                  _page, _limit);
                        },
                        child: Text('Refresh'),
                      ),
